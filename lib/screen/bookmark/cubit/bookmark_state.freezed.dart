...
abstract class _$$BookmarksLoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ReferenceModel> bookmarks});
}
...
class _$BookmarksLoadedImpl implements _BookmarksLoaded {
  const _$BookmarksLoadedImpl(final List<ReferenceModel> bookmarks)
      : _bookmarks = bookmarks;

  final List<ReferenceModel> _bookmarks;
  @override
  ...
  @override
  String toString() {
    return 'BookmarkState.bookmarksLoaded(bookmarks: $bookmarks)';
  }
...
abstract class _BookmarksLoaded implements BookmarkState {
  const factory _BookmarksLoaded(final List<ReferenceModel> bookmarks) =
...
class _$HistoryLoadedImpl implements _HistoryLoaded {
  ...
  @override
  String toString() {
    return 'BookmarkState.historyLoaded(history: $history)';
  }
...
class _$BookmarkTappedImpl implements _BookmarkTapped {
  const _$BookmarkTappedImpl(this.bookmark);

  @override
  final ReferenceModel bookmark;

  @override
  String toString() {
    return 'BookmarkState.bookmarkTapped(bookmark: $bookmark)';
  }
...
abstract class _BookmarkTapped implements BookmarkState {
  const factory _BookmarkTapped(final ReferenceModel bookmark) =
