...
<body>
  ...
  <p><span class="quran">* الترجمة إلى الانجليزية المتوفرة على موقع al-islam.org الموقر.</span></p>

  <p><span class="quran">* الترجمة إلى الفارسية من إعداد: الشيخ علي نقي فيض الإسلام الأصفهاني.</span></p>

  <p><span class="quran">* الترجمة إلى الفارسية من إعداد : السيد جعفر الشهيدي.<br /></span></p>

  <p><span class="quran">* الترجمة إلى الفارسية من إعداد : الشيخ محمد تقي الجعفري.<br /></span></p>

  <p><span class="quran">* الترجمة إلى الفارسية من إعداد : الشيخ حسين أنصاريان.<br /></span></p>

  <p><span class="quran">* شرح الكلمات الغامضة بما جاء في شرح الشيخ محمد عبده والدكتور صبحي الصالح.</span></p>

  <p>إضافة إلى الميزات العامة من البحث والإشارات المرجعية التي لا تخلو منها التطبيقات.</p>

  <p>وفي الختام نهدي ثواب عملنا المتواضع هذا لروح <span class="quran">الشهيد الشيخ حسين حمودي</span><span class="fm">(رحمه الله)</span> راجين من الله سبحانه أن يجعله ثواباً واصلاً، وعملاً مقبولاً، إنه أرحم الراحمين.</p>
