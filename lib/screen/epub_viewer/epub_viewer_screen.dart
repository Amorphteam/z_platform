...
import 'package:zahra/screen/epub_viewer/widgets/translation_bottom_sheet_content.dart';
        ...
        state.maybeWhen(
          ...
          translationLoaded: (translation) {
            ...
            showModalBottomSheet(
              ...
              builder: (context) => TranslationBottomSheetContent(translation: translation),
            ).then((_) {
