...
import 'package:zahra/screen/hekam/widgets/favorites_bottom_sheet.dart';
...
class HekamScreen extends StatelessWidget {
  ...
  void _showFavoritesBottomSheet(BuildContext context) {
    final hekamCubit = context.read<HekamCubit>();
        ...
        builder: (context) {
          return Scaffold(
            ...
            appBar: CustomAppBar(
              ...
              showSearchBar: true,
              onRightTap: () => _showFavoritesBottomSheet(context),
            ),
